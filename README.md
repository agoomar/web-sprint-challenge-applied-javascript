...
1. What is the DOM?
    - It's a programming interface for HTML and XML documents. It represents the page so that programs can change the document structure, style and content.
2. What is an event?
    - An event is when "things" happen to HTML elements involving JavaScript. (e.g. A button with a onclick attribute and once you click it, it gives you the time)
3. What is an event listener?
    - It's a procedure in JavaScript that waits for the event to occur.
